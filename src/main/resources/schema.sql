...
ALTER TABLE `DAILY_HEALTH_CHECK` ADD CONSTRAINT `PK_DAILY_HEALTH_CHECK` PRIMARY KEY (`DAILY_HEALTH_NO`);
...
ALTER TABLE `DAILY_HEALTH_CHECK` MODIFY `DAILY_HEALTH_NO` BIGINT NOT NULL AUTO_INCREMENT;
