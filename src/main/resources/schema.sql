...
CREATE TABLE IF NOT EXISTS `PROJECT` (
	...
	`PROJECT_GENRE`	VARCHAR(100)	NULL,
...
CREATE TABLE IF NOT EXISTS `PROJECT_MEMBER` (
	...
	`MEMBER_NO`	BIGINT	NOT NULL	COMMENT 'MEMBER.MEMBER_NO 참조',
	`PROJECT_NO`	BIGINT	NOT NULL,
	`PROJECT_MEMBER_ROLE`	VARCHAR(50)	NOT NULL	DEFAULT '담당자'	COMMENT '담당자 / 작가 / 어시스트'
);
...
CREATE TABLE IF NOT EXISTS `KANBAN_CARD` (
	...
	`KANBAN_CARD_DESCRIPTION`	VARCHAR(2000)	NULL,
