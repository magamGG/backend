...
CREATE TABLE IF NOT EXISTS `PROJECT_MEMBER` (
	...
	`PROJECT_MEMBER_CREATED_AT`	DATETIME	NOT NULL	DEFAULT CURRENT_TIMESTAMP,
	`PROJECT_MEMBER_ENDED_AT`	DATETIME	NULL
);
...
-- Notion 연동 필드 추가
ALTER TABLE `PROJECT` ADD COLUMN IF NOT EXISTS `NOTION_ACCESS_TOKEN` VARCHAR(500) NULL;
ALTER TABLE `PROJECT` ADD COLUMN IF NOT EXISTS `NOTION_DATABASE_ID` VARCHAR(100) NULL;
ALTER TABLE `PROJECT` ADD COLUMN IF NOT EXISTS `NOTION_WORKSPACE_NAME` VARCHAR(100) NULL;
ALTER TABLE `KANBAN_CARD` ADD COLUMN IF NOT EXISTS `NOTION_PAGE_ID` VARCHAR(100) NULL;
ALTER TABLE `KANBAN_CARD` ADD COLUMN IF NOT EXISTS `NOTION_PAGE_URL` VARCHAR(500) NULL;
-- 포트폴리오 Notion OAuth
ALTER TABLE `PORTFOLIO` ADD COLUMN IF NOT EXISTS `NOTION_PAGE_ID` VARCHAR(36) NULL;
ALTER TABLE `PORTFOLIO` ADD COLUMN IF NOT EXISTS `NOTION_PAGE_URL` VARCHAR(500) NULL;
ALTER TABLE `PORTFOLIO` ADD COLUMN IF NOT EXISTS `NOTION_ACCESS_TOKEN` VARCHAR(500) NULL;
ALTER TABLE `PORTFOLIO` ADD COLUMN IF NOT EXISTS `NOTION_WORKSPACE_NAME` VARCHAR(100) NULL;
