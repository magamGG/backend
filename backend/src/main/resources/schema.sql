...
CREATE TABLE IF NOT EXISTS `KANBAN_CARD` (
	...
	`KANBAN_CARD_STATUS`	VARCHAR(20)	NOT NULL	COMMENT '해야 할 일 / 진행중 / 완료 (TODO / DOING / DONE)',
	`KANBAN_CARD_CREATED_AT`	DATETIME	NOT NULL,
	`KANBAN_CARD_UPDATED_AT`	DATETIME	NULL,
	`PROJECT_MEMBER_NO`	BIGINT	NOT NULL,
...
CREATE TABLE `DAILY_HEALTH_CHECK` (
    ...
    `HEALTH_CHECK_CREATED_AT`	DATETIME	NULL
);
